...
class TabPages extends PureComponent {
    ...
    componentWillMount() {
        ...
        const unClosedTabs = JSON.parse(window.sessionStorage.getItem('AntTabs')) || [homePageKey];
        const listObj = {};
        let txt = '';
        let words = '';
    ...
    remove = targetKey => {
        ...
        this.setState(
            ...
            () => {
                window.sessionStorage.setItem('AntTabs', JSON.stringify(Object.keys(tabListObj)));
                if (needRouterPush) {
    ...
    renderTabs = props => {
        ...
        this.setState(
            ...
            () => {
                window.sessionStorage.setItem('AntTabs', JSON.stringify(Object.keys(listObj)));
            }
        );
    };
